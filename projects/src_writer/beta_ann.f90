...
double precision, dimension(2,20) :: weight_ann_hc_pure_2
...
double precision, dimension(2,20), intent(in) :: weight_ann_hc_pure_2
...
!LAYER 1
x_hidden_1 = matmul(weight_ann_hc_pure_1, data_in)
...
beta_results(1) = 0.5D0*(beta_results(1) + 1.D0)*(output_max_out(2) - output_min_out(2)) +output_min_out(2)
beta_results(1) = 10**beta_results(1)
beta_results(2) = 0.5D0*( beta_results(2)+ 1.D0)*(output_max_out(1) - output_min_out(1)) +output_min_out(1)
