module ann_coag
implicit none
double precision, dimension(10,6) :: weight_ann_hc_pure_1
double precision, dimension(2,10) :: weight_ann_hc_pure_2
double precision, dimension(10) :: b_ann_hc_pure_1
...
double precision, dimension(10,6), intent(in) :: weight_ann_hc_pure_1
double precision, dimension(2,10), intent(in) :: weight_ann_hc_pure_2
double precision, dimension(10), intent(in) :: b_ann_hc_pure_1
