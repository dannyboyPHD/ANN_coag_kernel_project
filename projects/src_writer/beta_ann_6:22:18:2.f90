module ann_coag
implicit none
double precision, dimension(22,6) :: weight_ann_hc_pure_1
double precision, dimension(18,22) :: weight_ann_hc_pure_2
double precision, dimension(2,18) :: weight_ann_hc_pure_3
double precision, dimension(22) :: b_ann_hc_pure_1
double precision, dimension(18) :: b_ann_hc_pure_2
...
double precision, dimension(22,6), intent(in) :: weight_ann_hc_pure_1
double precision, dimension(18,22), intent(in) :: weight_ann_hc_pure_2
double precision, dimension(2,18), intent(in) :: weight_ann_hc_pure_3
double precision, dimension(22), intent(in) :: b_ann_hc_pure_1
double precision, dimension(18), intent(in) :: b_ann_hc_pure_2
...
double precision, dimension(22) :: x_hidden_1
double precision, dimension(18) :: x_hidden_2
