module ann_coag
implicit none
double precision, dimension(40,6) :: weight_ann_hc_pure_1
double precision, dimension(2,40) :: weight_ann_hc_pure_2
double precision, dimension(40) :: b_ann_hc_pure_1
...
double precision, dimension(40,6), intent(in) :: weight_ann_hc_pure_1
double precision, dimension(2,40), intent(in) :: weight_ann_hc_pure_2
double precision, dimension(40), intent(in) :: b_ann_hc_pure_1
...
double precision, dimension(40) :: x_hidden_1
