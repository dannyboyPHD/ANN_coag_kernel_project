...
double precision, dimension(20,5), intent(in) :: weight_1
double precision, dimension(10,20), intent(in) :: weight_2
double precision, dimension(5,10), intent(in) :: weight_3
double precision, dimension(5), intent(in) :: weight_4
double precision, dimension(20), intent(in) :: b_1
double precision, dimension(10), intent(in) :: b_2
double precision, dimension(5), intent(in) :: b_3
...
double precision, dimension(10) :: x_hidden_2
