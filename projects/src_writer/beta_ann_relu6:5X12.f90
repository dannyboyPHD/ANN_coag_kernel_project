module ann_coag
implicit none
double precision, dimension(12,6) :: weight_ann_hc_pure_1
double precision, dimension(12,12) :: weight_ann_hc_pure_2
double precision, dimension(12,12) :: weight_ann_hc_pure_3
double precision, dimension(12,12) :: weight_ann_hc_pure_4
double precision, dimension(12,12) :: weight_ann_hc_pure_5
double precision, dimension(2,12) :: weight_ann_hc_pure_6
double precision, dimension(12) :: b_ann_hc_pure_1
double precision, dimension(12) :: b_ann_hc_pure_2
double precision, dimension(12) :: b_ann_hc_pure_3
double precision, dimension(12) :: b_ann_hc_pure_4
double precision, dimension(12) :: b_ann_hc_pure_5
double precision, dimension(2) :: b_ann_hc_pure_6
...
&max_out,output_min_out,weight_ann_hc_pure_1,b_ann_hc_pure_1,weight_ann_hc_pure_2,b_ann_hc_pure_2,weight_ann_hc_pure_3,b_ann_hc_pure_3,weight_ann_hc_pure_4,b_ann_hc_pure_4,weight_ann_hc_pure_5,b_ann_hc_pure_5,weight_ann_hc_pure_6,b_ann_hc_pure_6)
double precision, dimension(6), intent(in) :: data_in
double precision, dimension(6) :: data_inputs
double precision, dimension(12,6), intent(in) :: weight_ann_hc_pure_1
double precision, dimension(12,12), intent(in) :: weight_ann_hc_pure_2
double precision, dimension(12,12), intent(in) :: weight_ann_hc_pure_3
double precision, dimension(12,12), intent(in) :: weight_ann_hc_pure_4
double precision, dimension(12,12), intent(in) :: weight_ann_hc_pure_5
double precision, dimension(2,12), intent(in) :: weight_ann_hc_pure_6
double precision, dimension(12), intent(in) :: b_ann_hc_pure_1
double precision, dimension(12), intent(in) :: b_ann_hc_pure_2
double precision, dimension(12), intent(in) :: b_ann_hc_pure_3
double precision, dimension(12), intent(in) :: b_ann_hc_pure_4
double precision, dimension(12), intent(in) :: b_ann_hc_pure_5
double precision, dimension(2), intent(in) :: b_ann_hc_pure_6
...
double precision, dimension(12) :: x_hidden_2
double precision, dimension(12) :: x_hidden_3
double precision, dimension(12) :: x_hidden_4
double precision, dimension(12) :: x_hidden_5
...
!LAYER 3
x_hidden_3 = matmul(weight_ann_hc_pure_3,x_hidden_2)
x_hidden_3 = x_hidden_3+b_ann_hc_pure_3
x_hidden_3 = relu(x_hidden_3)
!LAYER 4
x_hidden_4 = matmul(weight_ann_hc_pure_4,x_hidden_3)
x_hidden_4 = x_hidden_4+b_ann_hc_pure_4
x_hidden_4 = relu(x_hidden_4)
!LAYER 5
x_hidden_5 = matmul(weight_ann_hc_pure_5,x_hidden_4)
x_hidden_5 = x_hidden_5+b_ann_hc_pure_5
x_hidden_5 = relu(x_hidden_5)


!OUTPUT LAYER
beta_results = matmul(weight_ann_hc_pure_6, x_hidden_5)
beta_results = beta_results +b_ann_hc_pure_6
...
do i = 1,size(weight_ann_hc_pure_4,1)
do j = 1,size(weight_ann_hc_pure_4,2)
read(88,*) weight_ann_hc_pure_4(i,j)
off = off +1
end do
end do
do i = 1,size(weight_ann_hc_pure_5,1)
do j = 1,size(weight_ann_hc_pure_5,2)
read(88,*) weight_ann_hc_pure_5(i,j)
off = off +1
end do
end do
! FINAL LAYER
do i = 1,size(weight_ann_hc_pure_6,1)
do j = 1,size(weight_ann_hc_pure_6,2)
read(88,*) weight_ann_hc_pure_6(i,j)
off = off +1
end do
end do
close(88)
...
do i = 1,size(b_ann_hc_pure_4)
read(88,*) b_ann_hc_pure_4(i)
end do
do i = 1,size(b_ann_hc_pure_5)
read(88,*) b_ann_hc_pure_5(i)
end do
do i = 1,size(b_ann_hc_pure_6)
read(88,*) b_ann_hc_pure_6(i)
end do
close(88)
end subroutine
