module ann_coag
implicit none
double precision, dimension(8,6) :: weight_ann_hc_pure_1
double precision, dimension(7,8) :: weight_ann_hc_pure_2
double precision, dimension(2,7) :: weight_ann_hc_pure_3
double precision, dimension(8) :: b_ann_hc_pure_1
double precision, dimension(7) :: b_ann_hc_pure_2
...
double precision, dimension(8,6), intent(in) :: weight_ann_hc_pure_1
double precision, dimension(7,8), intent(in) :: weight_ann_hc_pure_2
double precision, dimension(2,7), intent(in) :: weight_ann_hc_pure_3
double precision, dimension(8), intent(in) :: b_ann_hc_pure_1
double precision, dimension(7), intent(in) :: b_ann_hc_pure_2
...
double precision, dimension(7) :: x_hidden_2
