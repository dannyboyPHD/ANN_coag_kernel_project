module ann_coag
implicit none
double precision, dimension(7,6) :: weight_ann_hc_pure_1
double precision, dimension(3,7) :: weight_ann_hc_pure_2
double precision, dimension(2,3) :: weight_ann_hc_pure_3
double precision, dimension(7) :: b_ann_hc_pure_1
double precision, dimension(3) :: b_ann_hc_pure_2
...
double precision, dimension(7,6), intent(in) :: weight_ann_hc_pure_1
double precision, dimension(3,7), intent(in) :: weight_ann_hc_pure_2
double precision, dimension(2,3), intent(in) :: weight_ann_hc_pure_3
double precision, dimension(7), intent(in) :: b_ann_hc_pure_1
double precision, dimension(3), intent(in) :: b_ann_hc_pure_2
...
double precision, dimension(7) :: x_hidden_1
double precision, dimension(3) :: x_hidden_2
