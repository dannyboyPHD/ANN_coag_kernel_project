module ann_coag
implicit none
double precision, dimension(15,6) :: weight_ann_hc_pure_1
double precision, dimension(2,15) :: weight_ann_hc_pure_2
...
double precision, dimension(15,6), intent(in) :: weight_ann_hc_pure_1
double precision, dimension(2,15), intent(in) :: weight_ann_hc_pure_2
double precision, dimension(15), intent(in) :: b_ann_hc_pure_1
