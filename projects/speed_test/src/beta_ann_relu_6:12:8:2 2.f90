...
double precision, dimension(8,12) :: weight_ann_hc_pure_2
double precision, dimension(2,8) :: weight_ann_hc_pure_3
double precision, dimension(12) :: b_ann_hc_pure_1
double precision, dimension(8) :: b_ann_hc_pure_2
...
double precision, dimension(8,12), intent(in) :: weight_ann_hc_pure_2
double precision, dimension(2,8), intent(in) :: weight_ann_hc_pure_3
double precision, dimension(12), intent(in) :: b_ann_hc_pure_1
double precision, dimension(8), intent(in) :: b_ann_hc_pure_2
...
double precision, dimension(8) :: x_hidden_2
