module ann_coag
implicit none
double precision, dimension(30,6) :: weight_ann_hc_pure_1
double precision, dimension(5,30) :: weight_ann_hc_pure_2
double precision, dimension(5,5) :: weight_ann_hc_pure_3
double precision, dimension(2,5) :: weight_ann_hc_pure_4
double precision, dimension(30) :: b_ann_hc_pure_1
double precision, dimension(5) :: b_ann_hc_pure_2
double precision, dimension(5) :: b_ann_hc_pure_3
double precision, dimension(2) :: b_ann_hc_pure_4
contains 
...
&max_out,output_min_out,weight_ann_hc_pure_1,b_ann_hc_pure_1,weight_ann_hc_pure_2,b_ann_hc_pure_2,weight_ann_hc_pure_3,b_ann_hc_pure_3,weight_ann_hc_pure_4,b_ann_hc_pure_4)
double precision, dimension(6), intent(in) :: data_in
double precision, dimension(6) :: data_inputs
double precision, dimension(30,6), intent(in) :: weight_ann_hc_pure_1
double precision, dimension(5,30), intent(in) :: weight_ann_hc_pure_2
double precision, dimension(5,5), intent(in) :: weight_ann_hc_pure_3
double precision, dimension(2,5), intent(in) :: weight_ann_hc_pure_4
double precision, dimension(30), intent(in) :: b_ann_hc_pure_1
double precision, dimension(5), intent(in) :: b_ann_hc_pure_2
double precision, dimension(5), intent(in) :: b_ann_hc_pure_3
double precision, dimension(2), intent(in) :: b_ann_hc_pure_4
...
double precision, dimension(30) :: x_hidden_1
double precision, dimension(5) :: x_hidden_2
double precision, dimension(5) :: x_hidden_3
...
!OUTPUT LAYER
beta_results = matmul(weight_ann_hc_pure_4, x_hidden_3)
beta_results = beta_results +b_ann_hc_pure_4
