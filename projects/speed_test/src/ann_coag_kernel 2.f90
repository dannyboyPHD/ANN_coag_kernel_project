pure double precision function ann_hc_pure(data_in,min_in,max_in,output_max_out,output_min_out,weight_1,b_1,weight_2,b_2,weight_3,b_3,weight_4,b_4)
...
double precision, dimension(2,10), intent(in) :: weight_2
