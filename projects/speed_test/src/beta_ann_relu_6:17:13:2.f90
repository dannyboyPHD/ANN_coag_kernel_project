module ann_coag
implicit none
double precision, dimension(17,6) :: weight_ann_hc_pure_1
double precision, dimension(13,17) :: weight_ann_hc_pure_2
double precision, dimension(2,13) :: weight_ann_hc_pure_3
double precision, dimension(17) :: b_ann_hc_pure_1
double precision, dimension(13) :: b_ann_hc_pure_2
...
! double precision function beta_2out(data_in)
double precision, dimension(6), intent(in) :: data_in
double precision, dimension(6) :: data_inputs
double precision, dimension(17,6), intent(in) :: weight_ann_hc_pure_1
double precision, dimension(13,17), intent(in) :: weight_ann_hc_pure_2
double precision, dimension(2,13), intent(in) :: weight_ann_hc_pure_3
double precision, dimension(17), intent(in) :: b_ann_hc_pure_1
double precision, dimension(13), intent(in) :: b_ann_hc_pure_2
...
double precision, dimension(17) :: x_hidden_1
double precision, dimension(13) :: x_hidden_2
